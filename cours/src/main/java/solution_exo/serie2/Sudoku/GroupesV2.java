...
public class GroupesV2 {
    ...
    public int findAndSetPlaceableCase(){
        ...
        for(int val = 1; val < 10; val++){
            if(this.valeurPossibles[val -1]){
                ...
                //Si 5 ne peux ête placé qu'à un seul endroit je le place
                nbPoss = 0;
                idx = -1;
                for(int i = 0 ; i < 9; i++){
    ...
    public static void main(String[] args) {
        ...
        // Créer un groupe
        GroupesV2 groupe = new GroupesV2(sudoku, coords);
        ...
        //Cas 2
        groupe = new GroupesV2(sudoku, coords);
    ...
    public static void testFindPlaceable(GroupesV2 groupe, String should){
