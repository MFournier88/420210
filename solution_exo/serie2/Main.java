...
class Groupe{
    ...
    public byte moyenneGenerale(){
        ...
        for(int i =0 ; i < this.etudiants.size() ; i++){
            somme += this.etudiants.get(i).noteFinale();
        }
        return (byte) (somme / this.etudiants.size());
    }
...
class Etudiant{
    ...
    public void afficheResultat(){
        System.out.print(this.da + " " + this.nomComplet + " ".repeat(15 - this.nomComplet.length()));
        for(int i = 0 ; i < this.evaluations.length ; i++){
            System.out.print(this.evaluations[i].notePonderee() + " ");
        }
        System.out.print("| ");
        System.out.println(this.noteFinale());
    }
...
class Evaluation{
    ...
    public void afficherEvaluation(){
        ...
        System.out.println("Note pondérée: " + this.notePonderee());
    }
}